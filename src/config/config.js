...
const envVarsSchema = Joi.object()
  .keys({
    ...
    GOOGLE_CLIENT_SECRET: Joi.string().description('Google login client secret'),
    ...
    FACEBOOK_CLIENT_SECRET: Joi.string().description('Facebook login client secret'),
    FACEBOOK_CALLBACK_URL: Joi.string().description('Facebook login callback URL'),
  })
  .unknown();
